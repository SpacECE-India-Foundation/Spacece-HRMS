            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <?php if($this->session->userdata('user_type')=='EMPLOYEE' && $this->session->userdata('user_hr')==''){ ?>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Document Management </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>document/showUploadForm"> Upload Document </a></li>
                                <li><a href="<?php echo base_url(); ?>document/viewUploadedDocument"> Access Document</a></li>
                                <li><a href="<?php echo base_url(); ?>document/status"> Status </a></li>
                            </ul>
                        </li>         
                        <?php } else if($this->session->userdata('user_hr')==   'HR'){ ?>
                            <li> <a href="<?php echo base_url(); ?>Job/empjoblisting" ><i class="mdi mdi-gauge"></i><span class="hide-menu">Careers </span></a></li>
                            <li> <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employees </span></a>
                        </li>
                        <li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Document Management </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>document/DocumentView"> Review Document </a></li>
                                <li><a href="<?php echo base_url(); ?>document/hrUploadForm"> Upload Document</a></li>
                                <li><a href="<?php echo base_url(); ?>document/hr"> Manage HR </a></li>
                            </ul>
                        </li>                             
                        <?php } else { ?>
                            <li> <a href="<?php echo base_url(); ?>Job/joblisting" ><i class="mdi mdi-gauge"></i><span class="hide-menu">Careers </span></a></li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employees </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url(); ?>employee/createcourse">Training </a></li>
                        ...
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="<?php echo base_url(); ?>reimbursement/showform">Reimbursement Form</a></li>
                            <li><a href="<?php echo base_url(); ?>reimbursement/viewMyRequests">My List</a></li>
                        </ul>
                    </li>
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
