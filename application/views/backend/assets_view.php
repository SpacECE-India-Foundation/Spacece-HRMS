            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Logistice/logistic_support" class="text-white"><i class="" aria-hidden="true"></i>  Logistic Support List</a></button>
