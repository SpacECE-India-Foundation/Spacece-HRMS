        ...
        <div class="row m-b-10">
            <div class="col-12">
                ...
                <button type="button" class="btn btn-primary">
                    ...
                    <a href="<?php echo site_url('document/hrdoctitle'); ?>" class="text-white">Add Document Title for HR</a>
                    </button>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-6">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="hruploadDocument" id="uploadform" enctype="multipart/form-data">
